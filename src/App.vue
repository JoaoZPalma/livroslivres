  ...
  <div class="min-h-screen bg-[#A2D2DF] text-[#2E2E2E] space-y-6">
    ...
    <div class="bg-[#F6EFBD] p-6 shadow border-t-4 border-b-4 border-[#E9B86C]">
      ...
      <div class="flex flex-col items-center mt-4 space-y-2">
        ...
        <button class="bg-[#E9B86C] font-semibold px-6 py-2 rounded-xl hover:text-[#000]
    ...
    <div class="bg-[#F6EFBD] p-6 shadow text-center border-t-4 border-b-4 border-[#E9B86C]">
      ...
      <p class="mt-2">Localização:<br>Rua de Sabe Lá Deus, 123<br>9999-111 Tavira</p>
    </div>
    ...
    <div class="flex flex-col md:flex-row bg-[#F6EFBD] p-6 shadow text-center border-t-4 border-b-4 border-[#E9B86C]">
      ...
      />
        <button class="mt-4 bg-[#E9B86C] px-6 py-2 rounded-xl font-semibold">
          Realizar doação
        </button>
      </div>
    </div>
    ...
    <!-- Footer -->
    <div class="bg-[#F6EFBD] p-6 shadow flex flex-col md:flex-row items-center justify-around space-y-2 md:space-y-0 md:space-x-8 text-center border-t-4 border-b-4 border-[#E9B86C]">
      <div class="flex items-center space-x-1">
        ...
        <a href="https://www.instagram.com/pracadoslivroslivres" target="_blank" class="text-[#2E2E2E] hover:text-[#D17A22]">@pracadoslivroslivres</a>
      </div>
      <div class="flex items-center space-x-1">
        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
